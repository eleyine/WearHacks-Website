(function($) {
    ...
    $( document ).ready(function() {
        ...
        $(document).on('click', '.registration-form-action', function (e) {
            main();
    ...
    function mobileAndTabletcheck() {
      ...
      // Set to !check so I can test it on my browser
      return !check;
    }

    function registerOnMobile() {
